...
ALLOWED_HOSTS = ['unibet360.com', 'www.unibet360.com', 'localhost', '127.0.0.1']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '1000000/day' if DEBUG else '100/day',
        'user': '500000/hour' if DEBUG else '1000/hour',
        'burst': '60/minute',
    }
}
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'LetsBet API',
    'DESCRIPTION': 'API documentation for LetsBet platform',
    'VERSION': '1.0.0',
}
